            ...
            switch (e.getActionCommand()) {
                ...
                case "View JavaDoc": {
                    if (Desktop.isDesktopSupported()) {
                        try {
                            File myFile = new File("Project report.pdf");
                            if (myFile.exists()) {
                ...
                break;
                case "About": {
                    JOptionPane.showMessageDialog(null, "THIS PROGRAM IS WRITTEN AS A SEMESTER PROJECT OF OBJECT ORIENTED PROGRAMMING PROGRAMMIG  BY RIJUAN MAHMUD !");
                }
                break;
